<div class="Nesletter">
  ...
  <form
    action="https://tinyletter.com/yskrios"
    method="post"
    target="popupwindow"
    onsubmit="window.open('https://tinyletter.com/yskrios', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true"
  >
    <p><label for="tlemail">Enter your email address</label></p>
    <p><input type="text" style="width:140px" name="email" id="tlemail" /></p>
    <input type="hidden" value="1" name="embed" />
    <button class="btn" type="submit" value="Subscribe"> Subscribir </button>
  </form>
